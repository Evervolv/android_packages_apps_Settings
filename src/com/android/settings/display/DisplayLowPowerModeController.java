...
public class DisplayLowPowerModeController extends TogglePreferenceController implements
        Preference.OnPreferenceChangeListener {

    private LiveDisplayManager mLiveDisplayManager;
    private LiveDisplayConfig mConfig;

    public DisplayLowPowerModeController(Context context, String key) {
        super(context, key);
    ...
    public int getAvailabilityStatus() {
        ...
        return mConfig.hasFeature(LiveDisplayManager.FEATURE_CABC)
