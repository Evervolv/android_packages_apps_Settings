 ...
 */
public class DisplayColorPreference extends CustomDialogPreferenceExt {
    private static final String TAG = "DisplayColorPreference";
    ...
    public DisplayColorPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
