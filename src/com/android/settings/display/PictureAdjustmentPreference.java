 ...
 */
public class PictureAdjustmentPreference extends CustomDialogPreferenceExt {
    private static final String TAG = "PictureAdjustmentPreference";
    ...
    protected void onPrepareDialogBuilder(AlertDialog.Builder builder,
        ...
        builder.setNeutralButton(R.string.live_display_reset, null);
    ...
    private static class SavedState extends BaseSavedState {
        ...
        public static final Creator<SavedState> CREATOR =
                new Creator<PictureAdjustmentPreference.SavedState>() {

            public PictureAdjustmentPreference.SavedState createFromParcel(Parcel in) {
                return new PictureAdjustmentPreference.SavedState(in);
            }

            public PictureAdjustmentPreference.SavedState[] newArray(int size) {
                return new PictureAdjustmentPreference.SavedState[size];
            }
        };
    }
