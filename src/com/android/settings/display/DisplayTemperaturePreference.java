 ...
 */
public class DisplayTemperaturePreference extends CustomDialogPreferenceExt {
    private static final String TAG = "DisplayTemperaturePreference";
    ...
    public DisplayTemperaturePreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
