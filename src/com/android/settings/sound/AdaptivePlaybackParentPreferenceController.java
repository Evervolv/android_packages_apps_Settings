...
import static evervolv.provider.EVSettings.System.ADAPTIVE_PLAYBACK_ENABLED;
import static evervolv.provider.EVSettings.System.ADAPTIVE_PLAYBACK_TIMEOUT;
...
public class AdaptivePlaybackParentPreferenceController extends BasePreferenceController {
    ...
    public CharSequence getSummary() {
        boolean enabled = EVSettings.System.getIntForUser(
                mContext.getContentResolver(), ADAPTIVE_PLAYBACK_ENABLED, 0,
                UserHandle.USER_CURRENT) != 0;
        int timeout = EVSettings.System.getIntForUser(
