...
public class AdaptivePlaybackSoundPreferenceController extends BasePreferenceController
    ...
    public AdaptivePlaybackSoundPreferenceController(Context context, String preferenceKey) {
        ...
        mAdaptivePlaybackEnabled = EVSettings.System.getIntForUser(mContext.getContentResolver(),
                EVSettings.System.ADAPTIVE_PLAYBACK_ENABLED, 0, UserHandle.USER_CURRENT) != 0;
        mAdaptivePlaybackTimeout = EVSettings.System.getIntForUser(mContext.getContentResolver(),
    ...
    private final class SettingObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            if (ADAPTIVE_PLAYBACK.equals(uri) || ADAPTIVE_PLAYBACK_TIMEOUT.equals(uri)) {
                mAdaptivePlaybackEnabled = EVSettings.System.getIntForUser(
                        mContext.getContentResolver(), EVSettings.System.ADAPTIVE_PLAYBACK_ENABLED, 0,
                        UserHandle.USER_CURRENT) != 0;
                mAdaptivePlaybackTimeout = EVSettings.System.getIntForUser(
