...
import static evervolv.provider.EVSettings.System.VOLBTN_MUSIC_CONTROLS;
...
public class VolumeButtonMusicControlPreferenceController extends GesturePreferenceController {
    ...
    public boolean isChecked() {
        return EVSettings.System.getIntForUser(mContext.getContentResolver(), VOLBTN_MUSIC_CONTROLS,
                OFF, UserHandle.USER_CURRENT) == ON;
    }

    @Override
    public boolean setChecked(boolean isChecked) {
        return EVSettings.System.putIntForUser(mContext.getContentResolver(), VOLBTN_MUSIC_CONTROLS,
