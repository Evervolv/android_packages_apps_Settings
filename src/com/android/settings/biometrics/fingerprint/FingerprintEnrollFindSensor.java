...
public class FingerprintEnrollFindSensor extends BiometricEnrollBase {
    ...
    private static final int SENSOR_LOCATION_SCREEN = 4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sensorLocation < SENSOR_LOCATION_BACK || sensorLocation > SENSOR_LOCATION_SCREEN) {
        ...
        if (sensorLocation == SENSOR_LOCATION_SCREEN) {
            findViewById(R.id.fingerprint_sensor_location_front_overlay)
                    .setVisibility(View.VISIBLE);
